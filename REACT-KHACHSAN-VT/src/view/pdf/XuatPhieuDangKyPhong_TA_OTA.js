              ...
              <View style={[styles.table, { marginBottom: '5' }]}>
                ...
                <View style={styles.tableRow}>
                  <View style={[styles.emptyCellHangPhong, { width: '35%' }]}>
                    <Text>{thongTinThanhToan.ten_loai_phong}</Text>
                  </View>
                  ...
                  <View style={[styles.emptyCell, { width: '19%' }]}>
                    <Text>{thongTinThanhToan.ten_phong}</Text>
                  </View>
                </View>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={[styles.emptyCell, { width: '6%' }]}>
                    <Text>
                      {/* {thongTinThanhToan.so_giuong > 0 ? thongTinThanhToan.so_giuong : ''} */}
                      {''}
                    </Text>
                  </View>
                  <View style={[styles.emptyCell, { width: '11%' }]}>
                    {/* <Text>{thongTinThanhToan.so_giuong > 0 ? thongTinThanhToan.so_dem : ''}</Text> */}
                    {''}
                  </View>
                  <View style={[styles.emptyCell, { width: '17%' }]}>
                    <Text>
                      {/* {thongTinThanhToan.so_giuong > 0
                        ? formatCurrency(thongTinThanhToan.phu_thu_tien_giuong)
                        : ''} */}
                      {''}
                    </Text>
                  </View>
                  <View style={[styles.emptyCell, { width: '12%' }]}>
                    <Text>
                      {/* {thongTinThanhToan.so_giuong > 0
                        ? formatCurrency(
                            thongTinThanhToan.phu_thu_tien_giuong * thongTinThanhToan.so_dem,
                          )
                        : ''} */}
                      {''}
                    </Text>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={[styles.emptyCell, { width: '6%' }]}>
                    {/* <Text>{thongTinThanhToan.so_tre > 0 ? thongTinThanhToan.so_tre : ''}</Text> */}
                    {''}
                  </View>
                  <View style={[styles.emptyCell, { width: '11%' }]}>
                    <Text>{thongTinThanhToan.so_tre > 0 ? thongTinThanhToan.so_dem : ''}</Text>
                  </View>
                  <View style={[styles.emptyCell, { width: '17%' }]}>
                    <Text>
                      {/* {thongTinThanhToan.so_tre > 0
                          ? formatCurrency(thongTinThanhToan.phu_thu_tien_tre)
                          : ''} */}
                      {''}
                    </Text>
                  </View>
                  <View style={[styles.emptyCell, { width: '12%' }]}>
                    <Text>
                      {/* {thongTinThanhToan.so_tre > 0
                        ? formatCurrency(
                            thongTinThanhToan.phu_thu_tien_tre *
                              thongTinThanhToan.so_tre *
                              thongTinThanhToan.so_dem,
                          )
                        : ''} */}
                      {''}
                    </Text>
                ...
                <View style={styles.totalRow}>
                  ...
                  >
                    <Text>
                      {/* {formatCurrency(thongTinThanhToan.thanh_tien)} */}
                      {''}
                    </Text>
                  </View>
...
XuatPhieuDangKyPhong.propTypes = {
  ...
  thongTinThanhToan: PropTypes.shape({
    ...
    phu_thu_tien_tre: PropTypes.number.isRequired,
  ...
  const handleDownloadImage = useCallback(async () => {
    ...
    try {
      ...
      if (pdfDoc.numPages === 1) {
        ...
        link.download = `PhieuDangKyPhong_TA_OTA_${thongTinKhachHang.ma_booking}.png`
        ...
        const link = document.createElement('a')
        link.download = `PhieuDangKyPhong_TA_OTA_${thongTinKhachHang.ma_booking}_all.png`
